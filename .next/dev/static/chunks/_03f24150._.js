...
function TeamMemberPage({ params }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "TeamMemberPage.useEffect": ()=>{
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].getTeamMemberBySlug(slug).then({
                "TeamMemberPage.useEffect": (data)=>{
                    setMember(data);
                    setLoading(false);
                }
            }["TeamMemberPage.useEffect"]).catch({
                "TeamMemberPage.useEffect": (error)=>{
...
_s(TeamMemberPage, "dqKNXPfWb5dS2AxBqjFYGFdjBpY=", false, function() {
    return [
...
//# sourceMappingURL=_03f24150._.js.map